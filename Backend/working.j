...
app.use(cors({
  origin: [
    'http://13.60.205.60:8036', // Login Server
    'http://13.60.205.60:3412', // Employee Server
    'http://13.60.205.60:5500', // Live Server (Default)
    'http://13.60.205.60:5500', // Live Server (IP)
   // 'http://13.60.205.60:8037'  // Live Server (Alternate)
  ]
}));
